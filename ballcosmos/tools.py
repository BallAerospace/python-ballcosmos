...
def get_screen_list(config_filename = None, force_refresh = False):
  return ballcosmos.cmd_tlm_server.write('get_screen_list', config_filename, force_refresh)

# Get a specific screen definition
def get_screen_definition(screen_full_name, config_filename = None, force_refresh = False):
  return ballcosmos.cmd_tlm_server.write('get_screen_definition', screen_full_name, config_filename, force_refresh)

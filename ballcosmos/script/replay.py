...
def replay_select_file(filename, packet_log_reader = "DEFAULT"):
  return ballcosmos.script.script.cmd_tlm_server.write('replay_select_file', filename, packet_log_reader)

def replay_status():
  return ballcosmos.script.script.cmd_tlm_server.write('replay_status')

def replay_set_playback_delay(delay):
  return ballcosmos.script.script.cmd_tlm_server.write('replay_set_playback_delay', delay)
